...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--model",
        choices=("uniform", "population-proxy", "population-raster"),
        default="uniform",
        help="Demand model to build.",
    )
    ...
    parser.add_argument("--population-raster", type=Path, default=None, help="Population raster GeoTIFF.")
    ...
    parser.add_argument("--support-multiplier", type=float, default=3.0, help="Gaussian support radius multiplier.")
...
def main() -> None:
    ...
    if args.model == "uniform":
        ...
        if args.model == "population-proxy":
            ...
            population_raster = args.population_raster or PROJECT_ROOT / paths["population_raster"]
            load_population_raster_metadata(population_raster)
